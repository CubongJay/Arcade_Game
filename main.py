...
font = pygame.font.Font('assets/fonts/myFont.ttf', 32)
big_font = pygame.font.Font('assets/fonts/myFont.ttf', 60)
WIDTH = 900
HEIGHT = 800
...
def draw_level(coords):
    ...
    return target_rects
def draw_menu():
    global game_over, pause, mode, menu, total_shots, points, level, time_passed, ammo, time_remaining, best_freeplay, \
        best_timed, best_ammo, clicked, new_coords, write_values
    game_over = False
    pause = False
...
def draw_game_over():
    global menu, pause, game_over, level, clicked, total_shots, points, time_passed, time_remaining
    if mode == 0:
